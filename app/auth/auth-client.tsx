...
export default function AuthClient({
  ...
  const renderRegister = () => (
    <form style={formStyle} onSubmit={handleRegister}>
      ...
      <p style={registerHintStyle}>
        Todas las cuentas nuevas se crean como usuarios estándar. Si necesitas
        permisos administrativos, solicita apoyo a Bienestar Universitario.
      </p>
    </form>
  );
...
const registerHintStyle: CSSProperties = {
  margin: "4px 0 0",
  fontSize: "0.8rem",
  color: "#616d37",
  lineHeight: 1.4,
